...
1.  Open the published overlay URL in a browser.
2.  Confirm live data is updating.
3.  Add the URL to an OBS Browser Source.
4.  Set the required resolution.
5.  Refresh/reload the source when required.
6.  Verify both Link PC sources are represented.
